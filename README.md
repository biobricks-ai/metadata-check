...
# Run validator
python validate_metadata.py /path/to/repository
```
...
This action uses [uv](https://github.com/astral-sh/uv) for faster and more reliable dependency installation. The Docker image copies the `uv` binary from the official `ghcr.io/astral-sh/uv` image, providing:
